...
|---|---|---|---|---|---|
| 1 | LangGraph (基礎) | [langgraph/01-stategraph-and-reducer.md](langgraph/01-stategraph-and-reducer.md) | ✅完了 | 1, 6 | 0001 |
...
| 3 | RAG（検索戦略） | [rag/01-hybrid-search.md](rag/01-hybrid-search.md) | ✅完了 | 3 | 0006 |
| 4 | Vector DB（Qdrant） | [vector-db/01-qdrant-basics.md](vector-db/01-qdrant-basics.md) | ✅完了 | 3 | 0002 |
| 5 | マルチモーダルLLM | [multimodal-llm/01-vision-captioning.md](multimodal-llm/01-vision-captioning.md) | 執筆中 | 2 | 0003 |
| 6 | 動画前処理（OpenCV / YOLO） | [video-processing/01-frames-and-detection.md](video-processing/01-frames-and-detection.md) | ✅完了 | 1, 2 | - |
| 7 | 音声認識（Whisper） | [whisper-stt/01-transcription.md](whisper-stt/01-transcription.md) | ✅完了 | 1 | - |
...
| 11 | FastAPI / async / WebSocket | [fastapi-async/01-async-and-websocket.md](fastapi-async/01-async-and-websocket.md) | ✅完了 | 1, 8 | - |
| 12 | ツールチェーン（uv / ruff / mypy / pre-commit）| [toolchain/01-uv-and-ruff.md](toolchain/01-uv-and-ruff.md) | ✅完了 | 0 | 0007 |
| 13 | SQLModel / SQLAlchemy async / Alembic | [storage-sqlmodel/01-async-sqlmodel-alembic.md](storage-sqlmodel/01-async-sqlmodel-alembic.md) | ✅完了 | 1 | 0008 |
